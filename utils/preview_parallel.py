...
if __name__ == "__main__":
    ...
    # Create a multiprocessing pool with the number of processes you want to utilize
    num_processes = multiprocessing.cpu_count()-5  # Use number of CPU cores
    pool = multiprocessing.Pool(processes=num_processes)
    
    # Apply the process_item function to each item in the list using starmap
    # starmap requires the arguments to be in the form of an iterable of tuples
    pool.starmap(preview, enumerate(file_names))
