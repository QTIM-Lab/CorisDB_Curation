...
SELECT AVG(EXTRACT(YEAR FROM AGE(e.contact_date, p.birth_date))) AS average_age_at_encounter
FROM ehr.ophthalmologypatients p
JOIN ehr.ophthalmologyencounters e ON p.pat_mrn = e.pat_mrn;
