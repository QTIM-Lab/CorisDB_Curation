...
CREATE TABLE IF NOT EXISTS ehr.OphthalmologySurgeryAll (
    ...
    ANESTHSIOLOGIST VARCHAR(100),
    PNL_1_PRIM_PROC_NM VARCHAR(500),
...
CREATE TABLE IF NOT EXISTS ehr.OphthalmologyOrders (
    ...
    ORDERING_PROV_NAME VARCHAR(100),
    AUTHRIZING_PROV_NAME VARCHAR(100),
    BILLING_PROV_NAME VARCHAR(100),
    REFERRING_PROV_NAME VARCHAR(100),
    FINALIZING_PROV_NAME VARCHAR(100),
    ...
    PROC_CAT_ID INTEGER,
    ORDERING_CONTACT_DEP_ID VARCHAR(100),
    PAT_LOC_ID VARCHAR(100),
    ORDERING_PROV_ID INTEGER,
    PROC_ID INTEGER,
    AUTHRZING_PROV_ID INTEGER,
    BILLING_PROV_ID VARCHAR(100),
    ORD_CREATR_USER_ID VARCHAR(100),
    QUANTITY NUMERIC(18,6),
    REFERRING_PROV_ID VARCHAR(100),
    TECHNOLOGIST_ID VARCHAR(100),
    HV_HOSPITALIST_YN VARCHAR(100),
