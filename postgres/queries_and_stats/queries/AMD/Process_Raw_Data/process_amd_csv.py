...
os.chdir("/home/bearceb/coris_db/postgres/queries_and_stats/queries/AMD/Process_Raw_Data")
load_dotenv()
...
amd_csv_processed[header].to_csv(os.path.join(csv_path, "AMDDatabaseLogitudin_DATA_2023_08_17 MRNs.csv"), index=None)