...
amd_csv = pd.read_csv(os.path.join(csv_path), encoding='ISO-8859-1')
amd_csv.head()
list(amd_csv.columns)

header = ['mrn','can_use','ferris']
...
amd_csv_processed[header].to_csv(os.path.join(csv_path), index=None)
print(csv_path)