/* A new person table for glaucoma that is filterd from ICD 9 codes from
   - glaucoma.bb_gbq_diagnosis_<date> 
   - coris_registry.c3304_gbq_t1_person_<date>
*/

-- Use glaucoma.bb_gbq_encounter_diagnosis_<date> table to:
...
drop table if exists glaucoma.bb_gbq_person_20240925;
create table glaucoma.bb_gbq_person_20240925 as  
SELECT 
...
inner join glaucoma.bb_gbq_encounter_diagnosis_20240925 as glaucoma_e_d
