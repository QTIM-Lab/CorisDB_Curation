      ...
      patientImages: [
        {
          ...
          SpectralisOCTBScan: [
            {
              image_left: "e285333.png",
              image_right: "71cce01b.png"
            },
          ],
          SpectralisOCTAF: [
            {
              image_left: "6216123.png",
              image_right: "934ca2eb.png"
            },
          ],
          Eidon: [
            {
              image_left: "1f3a6ff.png",
              image_right: "6938458f.png"
            },
          ],
        },
        {
