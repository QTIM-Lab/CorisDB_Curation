...
<v-card>
  <v-card-text>
    <v-label>OCT RNFL Photo</v-label>
...
export default {
  data: () => ({
    ...
    imageSet: {
      ...
      images: [
          {
            image: "https://media.springernature.com/lw685/springer-static/image/art%3A10.1186%2Fs40942-020-0208-5/MediaObjects/40942_2020_208_Fig1_HTML.png",
          },
          {
            image: "https://media.springernature.com/lw685/springer-static/image/art%3A10.1186%2Fs40942-020-0208-5/MediaObjects/40942_2020_208_Fig1_HTML.png",
          }
