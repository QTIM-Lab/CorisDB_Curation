...
export default { // for drawer re-lookup vue code
  data: () => ({
    ...
    selectedPatientAutocomplete: null,
    tickLabels: {
          0: '2022-03-02',
          1: '2022-03-02',
          2: '2022-03-02',
    ...
    patientImages: [
      ...
      },
      {
        ...
        SpectralisOCTBScan: [
          {
            image_left: "/chosen_ones_amd/Spectralis_OCT_B_Scans/right/axis01_7286_492842_202203020931334112c090c1471cce01b.png",
            image_right: "/chosen_ones_amd/Spectralis_OCT_B_Scans/left/axis01_7286_492842_20220302093108607ec9fde881e285333.png",
          },
        ],
        SpectralisOCTAF: [
          {
            image_left: "/chosen_ones_amd/Spectralis_OCT_AF/right/axis01_7286_492842_20220302093142085e18105f4934ca2eb.png",
            image_right: "/chosen_ones_amd/Spectralis_OCT_AF/left/axis01_7286_492842_202203020931174052fba45d1f6216123.png",
          },
        ],
        Eidon: [
          {
            image_left: "/chosen_ones_amd/Eidon/right/axis01_7286_492841_20220302093058888d220fd006938458f.png",
            image_right: "/chosen_ones_amd/Eidon/left/axis01_7286_492841_20220302093059948f15012311f3a6ff.png",
          },
        ],
      },
    ]
  ...
  methods: {
    ...
    searchPatients() {
      ...
      const regex = /^(.*?)\s+\((\d+)\)$/; // Regular expression to match the name and number
      var match = inputString.match(regex);
      var name = null;
      var mrn = null;
      if (match) {
        name = match[1]; // Captured group 1 (.*?)
        mrn = match[2]; // Captured group 2 (\d+)
      } else {
        alert('No match found.');
      }
      this.selectedPatient = [this.patients.find((patient) => patient.mrn.toString() === mrn)][0];
      this.imageSet = [this.patientImages.find((imageSet) => imageSet.mrn.toString() === mrn)][0];
      // this.selectedPatient = Object.assign({}, this.patients.find((patient) => patient.mrn.toString() === mrn));
    },
  },
}
</script>
