      ...
      <v-col cols="9">
        ...
        <v-row>
          ...
          <v-col cols="6">
            ...
            <v-carousel @click="toggleOpticDiskSerialPhotoDialog" progress="primary">
            ...
            <v-dialog v-model="opticDiskSerialPhotoDialog" width="100%">
              ...
              <v-card>
                <v-card-text>
                  <v-label>Optic Disk Serial Photo</v-label>
                  <v-carousel height="100%" progress="primary" hide-delimiters>
                    <v-carousel-item cover v-for="(item, index) in imageSet.NonMyds">
          ...
          <v-col cols="6">
            ...
            <v-carousel @click="toggleVisualFieldDialog" progress="primary">
        ...
        <v-row>
          ...
          <v-col cols="6">
            ...
            <v-carousel @click="toggleOCTGCCReportDialog" progress="primary">
          ...
          <v-col cols="6">
            ...
            <v-carousel @click="toggleOCTRNFLReportDialog" progress="primary">
