...
labels_dicom = pd.read_csv("/scratch90/QTIM/Active/23-0284/EHR/AXISPACS/axispacs_image_types_dicom_manually_curated.csv")  # your table
labels_j2k = pd.read_csv("/scratch90/QTIM/Active/23-0284/EHR/AXISPACS/axispacs_image_types_j2k_manually_curated.csv")  # your table
...
#
all_dicoms = pd.read_csv(os.path.join(AXISPACS_DIR, 'all_dicoms_w_sop_desc.csv')) # , nrows=1000)
...
#
all_j2ks = pd.read_csv(os.path.join(AXISPACS_DIR, 'all_j2ks_w_sop_desc.csv')) # , nrows=1000)
...
#
all_files = pd.read_csv(os.path.join(AXISPACS_DIR, 'all_files_w_sop_desc.csv')) # , nrows=1000)
