DROP TABLE IF EXISTS axispacs.all_files;
CREATE TABLE axispacs.all_files (
    file_path TEXT,
    file_path_xml TEXT,
    mrn VARCHAR(200),
    FirstName TEXT,
...
/* Import */
\copy axispacs.all_files FROM '/scratch90/QTIM/Active/23-0284/EHR/AXISPACS/all_files_classified.csv' DELIMITERS ',' CSV QUOTE '"' HEADER;


/* Delete */
delete from axispacs.all_files;

/* Counts */
select count(*) from  axispacs.all_files; -- 

/* Explore */
select * from axispacs.all_files
limit 10;