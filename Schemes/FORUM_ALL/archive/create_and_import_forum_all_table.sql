...
DROP TABLE forum_all.dicom_headers;
CREATE TABLE IF NOT EXISTS forum_all.dicom_headers (
...
/* Import */
\copy forum_all.dicom_headers FROM '/scratch90/QTIM/Active/23-0284/EHR/FORUM_ALL/forum_all_sample_dicom_headers_parsed.csv' DELIMITERS ',' CSV QUOTE '"' HEADER;
\copy forum_all.dicom_headers FROM '/scratch90/QTIM/Active/23-0284/EHR/FORUM_ALL/forum_all_dicom_headers_parsed.csv' DELIMITERS ',' CSV QUOTE '"' HEADER;

-- vim /scratch90/QTIM/Active/23-0284/EHR/FORUM/forum_sample_dicom_headers_parsed.csv

/* Delete */
delete from forum_all.dicom_headers;

/* Counts */
select count(*) from  forum_all.dicom_headers; -- 37640


/* Explore */
select * from forum_all.dicom_headers
