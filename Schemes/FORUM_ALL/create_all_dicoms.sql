...
DROP TABLE IF EXISTS forum_all.all_dicoms;
CREATE TABLE forum_all.all_dicoms (
    file_path TEXT,
    mrn varchar(100),
...
/* Import */
\copy forum_all.all_dicoms FROM '/scratch90/QTIM/Active/23-0284/EHR/FORUM_ALL/parsed/forum_all_parse_dicom_for_postgres_.csv' DELIMITERS ',' CSV QUOTE '"' HEADER;


/* Delete */
delete from forum_all.all_dicoms;

/* Counts */
select count(*) from  forum_all.all_dicoms; -- 

/* Explore */
select * from forum_all.all_dicoms
limit 10;