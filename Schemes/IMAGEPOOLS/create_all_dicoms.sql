...
DROP TABLE IF EXISTS imagepools.all_dicoms;
CREATE TABLE imagepools.all_dicoms (
    file_path TEXT,
    mrn varchar(100),
...
/* Import */
\copy imagepools.all_dicoms FROM '/scratch90/QTIM/Active/23-0284/EHR/IMAGEPOOLS/parsed/imagepools_parse_dicom_for_postgres_.csv' DELIMITERS ',' CSV QUOTE '"' HEADER;


/* Delete */
delete from imagepools.all_dicoms;

/* Counts */
select count(*) from  imagepools.all_dicoms; -- 

/* Explore */
select * from imagepools.all_dicoms
limit 10;